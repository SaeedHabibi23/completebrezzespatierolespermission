                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{ route('admin.permission.edit', $Permission->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                        <form class="me-5" action="{{ route('admin.permission.destroy', $Permission->id) }}" method="POST" onsubmit="return confirm('Are You Sure')">
                                                            @csrf
                                                            @method('DELETE')
